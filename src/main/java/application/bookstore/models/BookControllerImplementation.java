...
import application.bookstore.models.BookControllerInterface;
...
public class BookControllerImplementation implements BookControllerInterface {

    private final BookView bookView;

    public BookControllerImplementation(BookView bookView) {
