...
public class TestUser {
    ...
    void test_UserSavedInFile() throws IOException, ClassNotFoundException {
        ...
        ObjectInputStream is = new ObjectInputStream(new FileInputStream("C:\\Users\\pc\\Downloads\\Software-Test-Head\\Software-Test-Head\\src\\main\\resources\\data\\users.ser"));
